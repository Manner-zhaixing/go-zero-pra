...
func (c *userClient) GetUser(ctx context.Context, in *UserReq, opts ...grpc.CallOption) (*UserRes, error) {
	out := new(UserRes)
...
func (UnimplementedUserServer) GetUser(context.Context, *UserReq) (*UserRes, error) {
